...
<Grid fluid>
    ...
    <Col md={12}>
       <Jumbotron className="selectteam">
        <iframe className="mx-auto" width="100%" height="500" title="provisional" src="https://www.youtube.com/embed/mP36g8I_0GY" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen />
      </Jumbotron>
     </Col>
    </Row>  
    <Row>
